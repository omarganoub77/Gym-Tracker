...
<div class="bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 p-6 pb-12 rounded-b-[2rem] shadow-xl">
    <div class="flex items-center justify-between mb-4">
        ...
        <button onclick="app.showMenu = !app.showMenu; app.render()" class="bg-white/10 p-2 rounded-lg">⚙️</button>
    </div>
    <p class="text-blue-100 font-medium">Ready for your session, Gymbro?</p>
</div>
${this.showMenu ? `<div class="p-4 -mt-6 space-y-3">
    ...
    <button onclick="if(confirm('Switch program? Your current workouts will be replaced.')) { app.showOnboarding = true; localStorage.removeItem('programSelected'); app.render(); }" class="w-full bg-slate-900 border border-slate-700 p-4 rounded-xl font-black text-orange-400">Change Program</button>
...
const app = new GymApp();// Program Templates